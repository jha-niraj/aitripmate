...
export async function POST(request: NextRequest) {
    try {
        ...
        await resend.emails.send({
            ...
            to: email,
            subject: "Your New AI TripMate Verification Code",
            html: `
<!DOCTYPE html>
<html lang="en">
      ...
      <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        <tr>
          <td style="background:#00A699;padding:32px 40px;text-align:center;">
            <h1 style="margin:0;color:#ffffff;font-size:24px;font-weight:700;">AI TripMate</h1>
          </td>
        </tr>
        <tr>
          <td style="padding:40px;">
            <p style="margin:0 0 16px;color:#374151;font-size:16px;">Hi <strong>${user.name}</strong>,</p>
            <p style="margin:0 0 24px;color:#6b7280;font-size:15px;line-height:1.6;">Here is your new verification code. It expires in <strong>10 minutes</strong>.</p>
